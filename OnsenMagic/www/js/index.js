...
function applyDeviceData(device) {
    ...
    document.getElementById('deviceModel').innerText = device.model;
    document.getElementById('operatingSystem').innerText = device.platform;
}
